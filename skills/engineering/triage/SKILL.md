...
4. **Grill (if needed).** If the request needs fleshing out, call the Skill tool twice, for "matt:grilling" and "matt:domain-modeling", and grill it into shape a round of questions at a time, sharpening domain terms and updating `CONTEXT.md`/ADRs inline as decisions land.
