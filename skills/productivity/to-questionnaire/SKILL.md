...
1. **Who is it going to?** Use the recipient's role, expertise, and relationship already supplied; ask in one exchange only for a missing detail that changes the questionnaire. This fixes the questionnaire's tone and how much context it must carry. Done when you know who the recipient is and what they know that the user doesn't.

2. **What do you need back?** Reuse the specific decisions or facts the user already needs from this person; ask in one exchange only when that gap remains unclear. Done when you have a concrete list of what the user must walk away able to do or decide.
